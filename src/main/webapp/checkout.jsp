                        ...
                        <form action="/editcart" method="post" id="myForm">
                            ...
                            <tr>
                                ...
                                <td class="quantity__item">
                                    <div class="quantity">
                                        <div class="pro-qty-2">
                                            <input name="quantityChange<%=item.getId()%>" class="quantity" type="number"
                                ...
                                <td class="cart__close"><a href="editcart?rpID=<%=item.getId()%>"
                                                           style="border: none"><i class="fa fa-close"></i></a></td>
                            </tr>
                            <%
                                    }
                                }
